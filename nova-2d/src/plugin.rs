...
use crate::{
    ...
    defaults::{default_sprite_material, default_white_texture, Nova2dDefaults},
...
impl Plugin for Nova2DPlugin {
    fn init(&self, ctx: &mut nova_core::app::ApplicationContext) -> nova_core::EngineResult<()> {
        ...
        let sprite_material = ctx.assets_manager.insert_asset(default_sprite_material(white_texture.clone()));
